% Simulate choice and confidence based on distributions of 
% learning and confidence parameters as estimated in our human sample.
...
pref = nan([nsims,nsub,8]);
accPost = nan([nsims,nsub,8]);
confPost  =nan([nsims,numel(idcTT),nsub,8]);
...
save('Results\SimulationsSubjParams.mat','outRL','outSorted',...
